...
# Save original
curr = os.getcwd()
image1 = Image.open(curr + "/databig/img/000001.jpg")
image1 = image.convert('L')
image1.save('img1.jpg', 'JPEG')
image2 = Image.open(curr + "/databig/img/000002.jpg")
image2 = image.convert('L')
image2.save('img2.jpg', 'JPEG')
image3 = Image.open(curr + "/databig/img/000003.jpg")
image3 = image.convert('L')
image3.save('img3.jpg', 'JPEG')
image4 = Image.open(curr + "/databig/img/000004.jpg")
