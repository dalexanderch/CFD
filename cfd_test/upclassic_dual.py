...
train_it = datagen.flow_from_directory(directory='data/big/', target_size=(200,80), shuffle=False, class_mode=None, batch_size=batch_size, subset='training')
val_it = datagen.flow_from_directory(directory='data/big/', target_size=(200,80), shuffle=False, class_mode=None, batch_size=batch_size, subset='validation')
train_small_it  = datagen.flow_from_directory(directory='data/small/', target_size=(100,40), shuffle=False, class_mode=None, batch_size=batch_size, subset='training')
val_small_it =  datagen.flow_from_directory(directory='data/small/', target_size=(100,40), shuffle=False, class_mode=None, batch_size=batch_size, subset='validation')
